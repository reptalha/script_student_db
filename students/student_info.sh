...
echo "$($PSQL "SELECT major FROM students FULL JOIN majors ON students.major_id = majors.major_id WHERE first_name ILIKE '%ma%' OR students.major_id IS NULL ORDER BY major;")"
